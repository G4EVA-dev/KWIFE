...
import CowrieAnimation from "../components/cowrieAnimation";
...
const ArtistProfile = () => {
  ...
  const sendCowrie = () => {
    ...
    setTimeout(() => {
      setCowrieSent(false);
      setIsAnimating(false); // Stop animation after 1.5 seconds
    }, 1500);
  };
      ...
      <header className="bg-gradient-to-b from-green-900 to-neutral-900 p-4 sm:p-8">
        <div className="container mx-auto flex flex-col sm:flex-row items-center">
          ...
          <div className="text-center sm:text-right">
            ...
            <button
              onClick={sendCowrie}
              className="bg-amber-500 text-neutral-900 px-6 py-3 rounded-full text-lg font-bold hover:bg-amber-400 transition duration-300 flex justify-center items-center "
            >
              <img
