...
function Auth({ onSuccessfulAuth }) {
  ...
  const handleAuth = async (e) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        // Handle signup logic
        authToken = await registerUser(name, email, password);
      }
  ...
  const loginUser = async (email, password) => {
    ...
    const response = await fetch('https://nobility-nodejs-backend-deployment.onrender.com/api/user/login', {
      method: 'POST',
  ...
  const registerUser = async (name, email, password) => {
    ...
    const response = await fetch('https://nobility-nodejs-backend-deployment.onrender.com/api/user/register', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
