...
import { LogOut, Plus, Music, Video } from "lucide-react"; // Removed unused Settings
      ...
      <header className="bg-green-800 p-4 sm:p-6">
        <nav className="mt-1 mb-4 flex justify-between items-center">
          ...
          {isAuthenticated ? (
            ...
            <motion.button
              ...
              className="bg-yellow-400 text-green-800 font-semibold py-2 px-4 rounded shadow hover:bg-yellow-300 transition duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Login
        ...
        <div className="container mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between">
          {isAuthenticated ? (
            ...
            <h1 className="text-white text-lg font-semibold">Welcome, Guest</h1>
          )}
        </div>
      </header>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
              ...
              <form onSubmit={handleUpload}>
                ...
                <div className="flex justify-end space-x-4">
                  ...
                  <button
                    type="submit"
                    className="py-2 px-4 bg-green-800 text-white rounded hover:bg-green-700"
                  >
                    Upload
                  </button>
                </div>
